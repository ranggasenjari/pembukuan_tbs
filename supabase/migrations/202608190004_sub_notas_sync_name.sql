-- Setelah rename kolom carrier_name -> name (0003), sesuaikan apply_offline_sync
-- agar sub nota di-sinkronkan lewat kolom `name` (payload offline kini memakai `name`).
